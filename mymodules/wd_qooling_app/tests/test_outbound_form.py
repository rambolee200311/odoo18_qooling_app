...
class TestQoolingOutboundForm(TransactionCase):
    ...
    def _signed_record(self):
        ...
        record.action_sign_driver(base64.b64encode(b"driver-image"))
        record.action_sign_warehouse(base64.b64encode(b"warehouse-image"))
        return record
    ...
    def test_submit_requires_both_signatures(self):
        record = self.env["wd.qooling.outbound.form"].with_user(self.operator).create(self._values())
    ...
    def test_un_number_and_evidence_are_recorded_without_automation(self):
        ...
        record.write({
            ...
            "cargo_photo": base64.b64encode(b"photo"),
        ...
        self.assertEqual(record.cargo_photo, base64.b64encode(b"photo"))
